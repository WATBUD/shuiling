...
public partial class World : Node3D
{
	...
	// Terrain build moved to scripts/World/World.Terrain.cs (Stage-0 — docs/ARCHITECTURE_REVIEW.md).
	...
	private void SpawnCityNpcs()
	{
		...
		CityNpcStation[] stations =
		{
			...
			new("name.npc.gacha", RingFrontOffset(60.0f, shopRadius, frontDistance), YawFacingCenter(RingOffset(60.0f, shopRadius)), 0.7f, "Support"),
	...
	// Terrain patch helper moved to scripts/World/World.Terrain.cs (Stage-0 — docs/ARCHITECTURE_REVIEW.md).
