...
public partial class SimpleActor : CharacterBody3D
{
	...
	// State (capture/recruit/world-map/party/collection/recovery) moved to SimpleActor.State.cs (Stage-0 — docs/ARCHITECTURE_REVIEW.md).
	...
	// State (formation/card bonuses, external-model path/card key) moved to SimpleActor.State.cs (Stage-0 — docs/ARCHITECTURE_REVIEW.md).
