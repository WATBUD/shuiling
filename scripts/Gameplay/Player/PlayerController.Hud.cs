...
public partial class PlayerController
{
	...
	{
		Input.MouseMode = _pauseMenuPanel.Visible || _partyPanel.Visible || _partyInvitePanel.Visible || _inventoryPanel.Visible || _formationPanel.Visible || _questLogPanel.Visible || _merchantShopPanel.Visible || _mercenaryShopPanel.Visible || _refinementPanel.Visible || _warehousePanel.Visible || _mailboxPanel.Visible || _composePanel.Visible || _cardAlbumPanel.Visible || _settingsPanel.Visible || (_npcQuestDialog != null && _npcQuestDialog.Visible) || (_mapTravelDialog != null && _mapTravelDialog.Visible) || (_wildReturnDialog != null && _wildReturnDialog.Visible)
